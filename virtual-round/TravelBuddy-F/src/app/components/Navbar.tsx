          ...
          {isLanding ? (
            ...
            <>
              ...
              <div className="flex items-center gap-3">
                ...
                <Link to="/profile" className="flex items-center gap-2 pl-2 pr-1 py-1 hover:bg-primary/10 rounded-full transition-all group">
                  <span className="text-sm font-medium text-slate-700 dark:text-slate-600 group-hover:text-primary hidden lg:block">
